...
My research interests are in Software Engineering (SE) and AI, including (1) integrating program analysis with LLMs to tackle real-world challenges, such as flaky test repair and SWE issue repair; (2) synthetic data generation, such as evaluating test flakiness detection tools and benchmarking LLMs. I also study LLM code reasoning. 

Prior research projects have equipped me with skills and experiences in neurosymbolic program analysis, genetic algorithms, LLM fine-tuning, as well as software testing including flaky tests detection & repair, mutation testing, and test suite minimization.
